...
def find_mean(comment_dict, like_dict, view_dict):    
   comment_mean = {}
   like_mean = {}
   view_mean = {}
...
def find_median(comment_dict, like_dict, view_dict):
    comment_median = {}
    like_median = {}
    view_median = {}    
...
def find_mode(comment_dict, like_dict, view_dict):    
    comment_mode = {}
    likes_mode = {}    
    views_mode = {}    
...
def find_standard_deviation(comment_dict, like_dict, view_dict):
    comment_sd = {}
    like_sd = {}
    view_sd = {}
...
def main():             
   comment_dict, like_dict, view_dict = get_lists()
   
   comment_mean, like_mean, view_mean = find_mean(comment_dict, like_dict, view_dict)
   comment_median, like_median, view_median = find_median(comment_dict, like_dict, view_dict)    
   comment_mode, like_mode, view_mode = find_mode(comment_dict, like_dict, view_dict)
   comment_sd, like_sd, view_sd = find_standard_deviation(comment_dict, like_dict, view_dict)
